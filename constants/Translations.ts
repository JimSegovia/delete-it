    ...
    es: {
        ...
        main: {
            ...
            config: {
                ...
                fromSelected: 'Desde foto elegida',
            ...
            source: {
                ...
                chooseSource: '¿Desde dónde quieres empezar?',
                ...
                manualDesc: 'Elige un rango de fotos específico',
                cancel: 'Cancelar',
                back: 'Atrás',
                start: 'Empezar'
            },
        ...
        swipe: {
            ...
            undo: 'Deshacer',
            finish: 'Finalizar',
            progress: '{current} de {total} fotos',
            ...
            batchDesc: '¿Deseas eliminar {count} fotos seleccionadas?',
            batchError: 'Ocurrió un error al eliminar algunas fotos.',
        ...
        mediaSelect: {
            ...
            tapEnd: 'Toca la foto final',
            tapFirst: 'Toca la primera foto',
            items: 'elementos',
            item: 'elemento',
    ...
    en: {
        ...
        onboarding: {
            ...
            slides: [
                ...
                {
                    title: 'Take Control',
                    description: 'You decide if you want to delete instantly or confirm at the end.',
                },
                {
                    title: '100% Private',
                    description: 'Your photos never leave your device. Everything is local and secure.',
                }
            ]
        },
        main: {
            ...
            config: {
                ...
                fromSelected: 'From chosen photo',
            ...
            source: {
                ...
                chooseSource: 'Where do you want to start?',
                ...
                recentDesc: 'From the latest photo (Recommended)',
                manualDesc: 'Choose a specific range of photos',
                cancel: 'Cancel',
                back: 'Back',
                start: 'Start'
            },
        ...
        swipe: {
            ...
            undo: 'Undo',
            finish: 'Finish',
            progress: '{current} of {total} photos',
            ...
            batchDesc: 'Do you want to delete {count} selected photos?',
            batchError: 'An error occurred while deleting some photos.',
        ...
        mediaSelect: {
            ...
            tapEnd: 'Tap the last photo',
            tapFirst: 'Tap the first photo',
            items: 'items',
            item: 'item',
